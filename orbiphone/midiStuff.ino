    ...
    if (ampl[i] > 0.01) {
      ...
      if (noteplaying[i] == 0) {
        ...
        */
        ...
        //noteplaying[i] = true;
        usbMIDI.sendNoteOn(noteplaying[i], midiPressure, i + 2);
        /*
                  Serial.print(i + 1);
      ...
      //usbMIDI.sendAfterTouchPoly(midiNote, midiPressure, i + 2);
      usbMIDI.sendAfterTouch( midiPressure, i + 2);
      //Serial.println(midiPressure);
      /*
        Serial.print(i+1);
        Serial.print(" playing ");
      ...
      usbMIDI.sendNoteOff(noteplaying[i], 0, i + 2);
      noteplaying[i] = 0;
      /*
        Serial.print(i + 1);
